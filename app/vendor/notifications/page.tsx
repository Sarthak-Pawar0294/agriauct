...
import { Bell, Check, TrendingUp, Trophy, Gavel, AlertTriangle } from "lucide-react"
            ...
            {notifications.length === 0 ? (
              <div className="py-12 text-center">
                ...
                <Button asChild variant="outline" className="mt-4">
                  <Link href="/vendor/browse">Start bidding on auctions</Link>
                </Button>
              </div>
            ) : (
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      {notification.listingId && (
                        <Link href={`/auction/${notification.listingId}`}>
                          <Button
                            variant={notification.type === "outbid" ? "default" : "ghost"}
                            size="sm"
                          >
                            {notification.type === "outbid" ? "Bid Now" : "View"}
                          </Button>
                        </Link>
                      )}
                      {!notification.isRead && (
